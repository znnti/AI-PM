---
name: product-asset-spec
description: Create, repair, or audit product asset specifications such as Asset-Spec.md, image/icon/avatar/cover/illustration slots, placeholder inventories, asset dimensions, crop rules, replacement constraints, and image-generation prompts. Use when Codex needs asset planning or asset-slot coverage for product HTML. Do not use for PRD writing, flow design, HTML coding, design-token work, or developer handoff.
---

# Product Asset Spec

Use this skill for Stage 6 asset slot and replacement planning.
...
Summarize covered slots, missing assets, prompt groups, and any HTML/design follow-up.
